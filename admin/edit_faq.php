            ...
            <form role="form" method="POST">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="mb-3">
                    <textarea class="textarea" placeholder="Place some text here" name="answer" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $data['answer']; ?></textarea>
                  </div>
                </div>
