...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Transporter Details</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Transporter Details</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-block btn-primary" href="edit_provider.php?id=<?= $id; ?>">EDIT</a>
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="transport">
                                    ...
                                    <dl>
                                        ...
                                        <a href="add_truck2.php?id=<?= $id; ?>" class="btn btn-success pull-right">Add
                                            Truck</a>
                                        <dt>Trucks</dt>
                                        </br>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align-last: center;"><a href="edit_truck2.php?edit=<?= $id2; ?>&uid=<?= $id ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                        ...
                                        <a href="add_route.php?id=<?= $id; ?>" class="btn btn-success pull-right">Add
                                            Route</a>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align-last: center;"><a href="edit_route.php?edit=<?= $id21; ?>&uid=<?= $id ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                    ...
                                    <dl>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['front_visiting']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['front_visiting']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['back_visiting']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['back_visiting']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['front_pan']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['front_pan']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['back_pan']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['back_pan']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['front_aadhar']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['front_aadhar']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['back_aadhar']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['back_aadhar']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['front_passbook']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['front_passbook']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['back_passbook']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['back_passbook']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['front_other']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['front_other']; ?>" style="width: 100%;height: auto;"></a></dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/pkyc/<?= $data['back_other']; ?>" target="blank"><img src="../android/Uploads/pkyc/<?= $data['back_other']; ?>" style="width: 100%;height: auto;"></a></dd>
