...
WHERE id = '$edit_id'";
                        ...
                        if (mysqli_query($con, $question_insert)) {
                            header('Location:loader_part_load_order.php?id=' . $edit_id);
                            //goback();
                        } else {
                        ...
                        <form role="form" id="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="" id="type" name="type" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pickup_city" value="<?= $pickup_city; ?>" name="pickup_city" placeholder="Pickup City" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="drop_city" value="<?= $drop_city; ?>" name="drop_city" placeholder="Drop City" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="quantity" value="<?= $quantity; ?>" name="quantity" placeholder="Quantity" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="remarks" value="<?= $remarks; ?>" name="remarks" placeholder="Special Notes">
