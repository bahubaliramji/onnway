  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Profile (<?= 'B00'.$id; ?>)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
				...
				while($report_data = mysqli_fetch_array($samplequery))
	{
          ...
          <div class="col-md-3">
            ...
            if(isset($_POST['deactivate']))
            {
				...
				$question_insert = "UPDATE `users` SET `status` = 'unsubscribed' WHERE `id` = '$id'";
            ...
            ?>
                ...
                <div class="card-footer">
                  <button type="submit" name="deactivate" class="btn btn-block btn-danger">UNSUBSCRIBE</button>
                </div>
              </form>
                <?php
				}
