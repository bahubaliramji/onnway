...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $squery =  "SELECT * FROM feedback WHERE id = '$id'";
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Feedback Section</li>
        ...
        <div class="col-12">
          ...
          if (isset($_POST['submit'])) {
            ...
            if (empty($reply) or empty($text_status) or empty($status)) {
              ...
              $question_insert = "UPDATE feedback SET reply = '$reply', text_status = '$text_status', status = '$status' WHERE id = '$id'";
