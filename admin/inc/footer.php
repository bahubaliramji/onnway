...
<script>
    ...
    $("#invoiceform").submit(function() {
        var form_data = $("#invoiceform").getFormObject();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response == 'success') {
                    location.replace("print/invoice.php?id=<?= $edit_id; ?>");
                }
            }
        });
...
<script>
    ...
    // This is how it's used
    $("#lrform").submit(function() {
        var form_data = $("#lrform").getFormObject1();
        console.log(form_data);
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response);
                if (response == 'success') {
                    location.replace("print/lr.php?id=<?= $edit_id; ?>");
                }
            }
        });
    ...
    $("#lrform2").submit(function() {
        var form_data = $("#lrform2").getFormObject1();
        console.log(form_data);
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response);
                if (response == 'success') {
                    location.replace("print/lr2.php?id=<?= $edit_id; ?>");
                }
            }
        });
    ...
    $("#lrform3").submit(function() {
        var form_data = $("#lrform3").getFormObject1();
        console.log(form_data);
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response);
                if (response == 'success') {
                    location.replace("print/lr3.php?id=<?= $edit_id; ?>");
                }
            }
        });
    ...
    $("#lrform4").submit(function() {
        var form_data = $("#lrform4").getFormObject1();
        console.log(form_data);
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response);
                if (response == 'success') {
                    location.replace("print/lr4.php?id=<?= $edit_id; ?>");
                }
            }
        });
...
<script>
    ...
    CKEDITOR.replace('payment_desc');
    CKEDITOR.replace('term_desc');
    CKEDITOR.replace('privacy_desc');
</script>
