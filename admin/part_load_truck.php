                                        ...
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between" style="width: 100%;">
                                                <div class="content" style="width: inherit;">
                                                    ...
                                                    <a class="btn btn-primary" href="edit_part_load_posted.php?edit=<?= $id; ?>">EDIT</a>
                                        ...
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between" style="width: 100%;">
                                                <div class="content" style="width: inherit;">
                                                    ...
                                                    <button type="button" id="canceltruck" class="btn btn-block btn-danger">CANCEL TRUCK</button>
