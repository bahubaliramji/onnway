...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add Promo Code</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (empty($code) or empty($discount)) {
                            ...
                            $question_insert = "INSERT INTO `promo` (
                      `code`,
                      `discount`,
                      `uses`,
                      `user_id`,
                        ...
                        <form role="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="uses" placeholder="Enter Uses" required>
                                </div>
