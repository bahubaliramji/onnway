                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 100%;" name="subcat2" aria-hidden="true" required>
                                        <?php
                                        $lid = $data['location_id'];
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['brand']; ?>" name="brand" placeholder="Enter Brand" required>
                                </div>
                                <div class="form-group">
                                    <label for="price">Price</label>
                                    <input type="number" class="form-control" value="<?= $data['price']; ?>" name="price" placeholder="Enter Price" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['size']; ?>" name="size" placeholder="Enter Size" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <input type="text" class="form-control" value="<?= $data['description']; ?>" name="description" placeholder="Enter Description" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['key_features']; ?>" name="key_features" placeholder="Enter Key Features" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['packaging_type']; ?>" name="packaging_type" placeholder="Enter Packaging Type" required>
                                </div>
                                <div class="form-group">
                                    <label for="shelf_life">Shelf Life</label>
                                    <input type="text" class="form-control" value="<?= $data['shelf_life']; ?>" name="shelf_life" placeholder="Enter Shelf Life" required>
                                </div>
