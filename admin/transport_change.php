...
$row33 = mysqli_query($con, "UPDATE count SET transport = 'unread'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Profile Change Requests</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Profile Change Requests</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped nowrap" style="width: 100%;">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM transport_change_request ORDER BY created DESC";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $city; ?></td>
                                                <td><?= $created; ?></td>
                                                <td style="text-align-last: center;"><a href="update_transport.php?edit=<?= $id; ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                            </tr>
                                    <?php }
                                    } ?>
                                </tbody>
