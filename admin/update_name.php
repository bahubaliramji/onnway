...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Name</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <form role="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="<?= $oldname; ?>" name="name" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Loader" value="<?= $name; ?>" name="Loader" placeholder="Loader" disabled>
