                                        ...
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between" style="width: 100%;">
                                                <div class="content" style="width: inherit;">
                                                    ...
                                                    <a class="btn btn-primary" href="edit_full_load_bid.php?edit=<?= $id; ?>">EDIT</a>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?= $bamount; ?></td>
                                                                                <td><?= $brow['created']; ?></td>
                                                                                <td><a id="accept" onclick="accept2(<?= $brow['id']; ?>)" type="button" class="btn btn-block btn-success">ACCEPT
                                                                                        BID</a></td>
