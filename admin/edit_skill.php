...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $squery =  "SELECT * FROM skills WHERE id = '$id'";
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Edit Skill Data</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          ...
          if (isset($_POST['submit'])) {
            ...
            if (empty($title) or empty($status) or empty($sector) or empty($title_hi)) {
              ...
              $question_insert = "UPDATE skills SET sector_id = '$sector', title = '$title', status = '$status',title_hi = '$title_hi' WHERE id = '$id'";
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" style="width: 100%;" name="sector" aria-hidden="true">
                    ...
                    ?>
                        <option value="<?= $id1; ?>" selected><?= $row['title']; ?></option>
                      <?php
                      } else {
                      ?>
                        <option value="<?= $id1; ?>"><?= $row['title']; ?></option>
                    <?php
                      }
                    }
                    ?>
