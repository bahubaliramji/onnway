...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Transporters</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">Transporters</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped nowrap" style="width: 100%;">
                ...
                <tbody>
                  <?php
                  $query = "SELECT * FROM users WHERE type = 'transporter' ORDER BY created DESC";
                  ...
                  if (mysqli_num_rows($query_run) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query_run)) {
                      ...
                      if (isset($row2)) {
                        ...
                        //   $st = 'VERIFIED';
                        // }
                        if ($ba_verify == 'verified' && $fa_verify == 'verified') {
                          $st = 'VERIFIED';
                        }
                  ...
                  ?>
                      <tr>
                        <td><?= $sno; ?></td>
                        <td><a href="provider_details.php?id=<?= $id; ?>"><?= $name; ?></a></td>
                        <td><?= $st; ?></td>
                        <td><?= $phone; ?></td>
                        <td><?= $row2['email']; ?></td>
                        <td><?= $email; ?></td>
