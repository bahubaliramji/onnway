...
$row33 = mysqli_query($con, "UPDATE count SET full_load = 'unread'");
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Full Load Bidding Enquiries</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">Full Load Bidding Enquiries</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                ...
                <tbody>
                  <?php
                  $query = "SELECT * FROM orders WHERE laod_type = 'full' AND (status = 'requsted for quote' OR status = 'accepted' OR status = 'assigned for quote' OR status = 'accepted quote') ORDER BY created DESC";
                  ...
                  ?>
                      <tr>
                        ...
                        ?>
                          <td><a href="loader_full_load_bid_order.php?id=<?= $id; ?>" type="button" class="btn btn-block btn-primary">ASSIGN FOR BIDDING</a></td>
                        <?php
                        } else if ($status == 'assigned for quote') {
                        ?>
                          <td><a href="loader_full_load_bid_order.php?id=<?= $id; ?>" type="button" class="btn btn-block btn-success">ACCEPT BID</a></td>
                        <?php
                        } else if ($status == 'accepted quote') {
                        ?>
                          <td><a href="loader_full_load_bid_order.php?id=<?= $id; ?>" type="button" class="btn btn-block btn-warning">BID ACCEPTED</a></td>
                        <?php
                        }
                        ?>
                        <td><?= $created; ?></td>
