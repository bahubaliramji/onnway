                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="../android/Uploads/profile/<?= $data['image']; ?>" alt="User profile picture">
                            </div>


                            <h3 class="profile-username text-center"><?php if (isset($data['name'])) {
                                                                            echo $data['name'];
                                                                        } ?></h3>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Email</b>
                                    <a class="float-right"><?php if (isset($data['email'])) {
                                                                echo $data['email'];
                                                            } ?></a>
                                </li>
                                <li class="list-group-item">
                                    ...
                                    <dl>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/lkyc/<?= $data['pan']; ?>" target="blank"><img src="../android/Uploads/lkyc/<?= $data['pan']; ?>" style="width: 100%;height: auto;"></a>
                                                </dd>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/lkyc/<?= $data['af']; ?>" target="blank"><img src="../android/Uploads/lkyc/<?= $data['af']; ?>" style="width: 100%;height: auto;"></a></dd>


                                            </div>

                                            <?php
                                            if (isset($data['af_verify'])) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <dd><a href="../android/Uploads/lkyc/<?= $data['ab']; ?>" target="blank"><img src="../android/Uploads/lkyc/<?= $data['ab']; ?>" style="width: 100%;height: auto;"></a></dd>
