...
if (isset($_GET['edit'])) {
    ...
    $edit_query = "SELECT * FROM employee WHERE id = '$edit_id'";
                ...
                <div class="col-12">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (empty($username) or empty($full_name) or empty($password)) {
                            ...
                            $question_insert = "UPDATE employee SET 
				  username = '$username',
				  full_name = '$full_name',
				  password = '$password',
				  data = '$datalist',
				  ...
				  other = '$otherslist' WHERE id = '$edit_id'
				  ";
                        ...
                        <form role="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $edit_row['username']; ?>" name="username" placeholder="Enter Username" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $edit_row['full_name']; ?>" name="full_name" placeholder="Enter Full Name" required>
                                </div>

                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="text" class="form-control" value="<?= $edit_row['password']; ?>" name="password" placeholder="Enter Password" required>
                                </div>
