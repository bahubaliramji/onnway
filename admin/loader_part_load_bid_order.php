    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Part Load Bidding Enquiry - Order #<?= $id; ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Part Load Bidding Enquiry - Order #<?= $id; ?></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                        ...
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between" style="width: 100%;">
                                                <div class="content" style="width: inherit;">
                                                    ...
                                                    <a class="btn btn-primary" href="edit_part_load_bid.php?edit=<?= $id; ?>">EDIT</a>
                                                    ...
                                                    <?php
                                                    if ($data['status'] == 'requsted for quote') {
                                                        $status1 = 'requested for quote';
                                                    } else {
                                                        $status1 = $data['status'];
                                                    }
                                                    ?>
                                                    <h4>Status</h4>
                                                    <p class="form-control"><?= $status1; ?></p>
                                                    <h4>Booking Date</h4>
                                        ...
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between" style="width: 100%;">
                                                <div class="content" style="width: inherit;">
                                                    ...
                                                    ?>
                                                        <button type="button" id="assign" class="btn btn-block btn-primary">ASSIGN FOR
                                                            BIDDING</button>
                                                    <?php
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?= $bpdata['name']; ?></td>
                                                                                <td><?= $budata['phone']; ?></td>
                                                                                <td><?= $row41['type'] . ' - ' . $row41['title']; ?></td>
                                                                                <td><?= $brow['load_passing']; ?></td>
                                                                                <td><?= $bamount; ?></td>
                                                                                <td><?= $brow['created']; ?></td>
                                                                                <td><a id="accept" onclick="accept3(<?= $brow['id']; ?>)" type="button" class="btn btn-block btn-success">ACCEPT
                                                                                        BID</a></td>
                                                                ...
                                                                <div class="box-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="exampleInputPassword1">New
                                                                            Freight</label>
                                                                        <input type="number" name="frieght" class="form-control" value="<?= $freight; ?>" disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="exampleInputPassword1">Other
                                                                            Charges</label>
                                                                        <input type="number" name="other" class="form-control" value="<?= $other_charges; ?>" disabled>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="exampleInputPassword1">CGST</label>
                                                                        <input type="number" name="cgst" class="form-control" value="<?= $cgst; ?>" disabled>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="exampleInputPassword1">SGST</label>
                                                                        <input type="number" name="sgst" class="form-control" value="<?= $sgst; ?>" disabled>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="exampleInputPassword1">Insurance</label>
                                                                        <input type="number" name="insurance" class="form-control" value="<?= $insurance; ?>" disabled>
                                                                    </div>
