            ...
            <form role="form" method="POST">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" step="any" class="form-control" id="max_load" name="max_load" placeholder="Max. Load" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" step="any" class="form-control" id="capcacity" name="capcacity" placeholder="Capcacity" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" step="any" class="form-control" id="box_length" name="box_length" placeholder="Box Length" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" step="any" class="form-control" id="box_width" name="box_width" placeholder="Box Width" required>
                  </div>
                </div>
