                        ...
                        <form role="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="freight" value="<?= $freight; ?>" name="freight" placeholder="Freight" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="other_charges" value="<?= $other_charges; ?>" name="other_charges" placeholder="Other Charges">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="cgst" name="cgst" value="<?= $cgst; ?>" placeholder="CGST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="sgst" value="<?= $sgst; ?>" name="sgst" placeholder="SGST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="insurance" value="<?= $insurance; ?>" name="insurance" placeholder="Insurance">
