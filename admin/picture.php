                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped nowrap">
                                ...
                                <tbody>
                                    <?php
                                    $selectquery = " SELECT * from business_settings WHERE img != '' ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo $res['img']; ?>" width="500px"></td>
                                            <td>
                                                <div class="table-data-feature" style="text-align: center;">
                                                    <form method="post" action="picture_update.php" class="d-inline">
