              ...
              <div class="card-body">
                <table id="example4" class="table table-bordered table-striped">
				  ...
				  <tr>
                    ...
                    <th><input id="officer" class="form-control form-control-sm" type="text" placeholder="officer"></th>
                    
                    <th>
					  <input type="text" style="width: auto;" class="form-control form-control-sm float-right" id="date">
				  ...
				  $query = "SELECT * FROM assigned_surveys WHERE (status = 'verified') ORDER BY created DESC";
	...
	else
	{
		...
		$cstreet = $sdata['cstreet'];
				  ...
				  <td><?= $type; ?></td>
					...
					{
					?>
					<td><a href="pending_worker_profile.php?id=<?= $profile_id; ?>&sid=<?= $row['id']; ?>"><?= $name; ?></a></td>
					<?php
					}
					else if($type == 'brand')
					{
					?>
					<td><a href="pending_brand_profile.php?id=<?= $profile_id; ?>&sid=<?= $row['id']; ?>"><?= $name; ?></a></td>
					<?php
					}
					else
					{
					?>
					<td><a href="pending_contractor_profile.php?id=<?= $profile_id; ?>&sid=<?= $row['id']; ?>"><?= $name; ?></a></td>
					<?php
					}
					?>
                    <td><?= $phone; ?></td>
