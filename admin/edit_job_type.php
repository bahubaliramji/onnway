...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $squery =  "SELECT * FROM roles WHERE id = '$id'";
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Edit Job Type Data</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          ...
          if (isset($_POST['submit'])) {
            ...
            if (empty($title) or empty($status) or empty($sector)) {
              ...
              $question_insert = "UPDATE roles SET sector_id = '$sector', title = '$title', status = '$status' WHERE id = '$id'";
