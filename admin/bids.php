...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">All Bids</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped nowrap">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM bids ORDER BY created DESC";
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_array($query_run)) {
                                            ...
                                            $query31 = mysqli_query($con, "SELECT * FROM provider_profile_tbl WHERE user_id = '$user_id'");
