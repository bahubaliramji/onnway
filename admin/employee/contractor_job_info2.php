        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="dashboard2.php">Home</a></li>
              <li class="breadcrumb-item active"><a href="contractor_jobs2.php">Contractor Jobs</a></li>
...
<?php
        ...
        ?>
                  ...
                  <tr>
                    ...
                    <td><?= $sno; ?></td>
                    <td><a href="contractor_profile2.php?id=<?= $workerdata['user_id']; ?>"><?= $workerdata['name']; ?></a></td>
		  ...
		  <div class="col-md-3">
            ...
            if(isset($_POST['deactivate']))
            {
				...
				$question_insert = "UPDATE `jobs_contractor` SET `status` = 'Inactive' WHERE `id` = '$id'";
            ...
            if(isset($_POST['activate']))
            {
				...
				$question_insert = "UPDATE `jobs_contractor` SET `status` = 'Active' WHERE `id` = '$id'";
                if(mysqli_query($con,$question_insert))
                {
                  header('Location:contractor_jobs2.php');
                }
