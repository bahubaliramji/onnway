  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Worker Profile (<?= 'W00'.$id; ?>)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
         ...
         else
         {
          ...
          <div class="col-md-3">
            ...
            if(isset($_POST['approve']))
            {
				...
				$question_insert = "UPDATE `workers` SET `status` = 'approved' WHERE `user_id` = '$id'";
                if(mysqli_query($con,$question_insert))
                {
					...
					$m = 'Congratulations, your profile has approved. Your Registration Number is W00'.$id;

		
		
		
		$qqq2 = mysqli_query($con,"INSERT INTO noti_worker (user_id , type , text) VALUES('$id', 'other' ,  '$m')");
