...
WHERE id = '$edit_id'";
                ...
                {
                  header('Location:loader_part_load_bid_order.php?id='.$edit_id);
                }
                else
                {
                      ...
                      ?>
                                    ...
                                    <div class="form-group">
                                        <label for="schedule">Schedule Date</label>
                                            ...
                                            <input type="text" class="form-control" id="schedule"
                                                value="<?= $schedule; ?>" name="schedule" placeholder="Schedule Date"
                                                required>
                                    ...
                                    <div class="form-group">
                                        <label for="material">Material</label>
                                            ...
                                            <select class="form-control select2" data-placeholder="" name="material"
                                                style="width: 100%;">
                      ...
                      ?>
                                    ...
                                    <div class="form-group">
                                        <label for="pickup_city">Pickup City</label>
                                            ...
                                            <input type="text" class="form-control" id="pickup_city"
                                                value="<?= $pickup_city; ?>" name="pickup_city"
                                                placeholder="Pickup City" required>
                                    ...
                                    <div class="form-group">
                                        <label for="length">Length</label>
                                            ...
                                            <input type="number" class="form-control" id="length"
                                                value="<?= $length; ?>" name="length" placeholder="Length" required>
                                    ...
                                    <div class="form-group">
                                        <label for="width">Width</label>
                                            ...
                                            <input type="number" class="form-control" id="width" value="<?= $width; ?>"
                                                name="width" placeholder="Width" required>
                                    ...
                                    <div class="form-group">
                                        <label for="height">Height</label>
                                            ...
                                            <input type="number" class="form-control" id="height"
                                                value="<?= $height; ?>" name="height" placeholder="Height" required>
                                    ...
                                    <div class="form-group">
                                        <label for="quantity">Quantity</label>
                                            ...
                                            <input type="number" class="form-control" id="quantity"
                                                value="<?= $quantity; ?>" name="quantity" placeholder="Quantity"
                                                required>
