				  ...
				  while($row = mysqli_fetch_array($run_query))
				  {
					...
					?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="key_features" placeholder="Enter Key Features"
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="packaging_type" placeholder="Enter Packaging Type"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="shelf_life">Shelf Life</label>
                                    <input type="text" class="form-control" name="shelf_life" placeholder="Enter Shelf Life"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="seller">Seller</label>
                                    <select class="form-control" style="width: 100%;" name="seller"
                                        aria-hidden="true" required>
                                        <?php
