...
?>
    ...
    <label for="max_load" class="col-sm-2 control-label">Max. Load</label>
                  <div class="col-sm-12">
                    <input type="number" class="form-control" value="<?= $data['max_load']; ?>" id="max_load" name="max_load" placeholder="Max. Load" required>
                  </div>
                </div> 
    ...
    <label for="capcacity" class="col-sm-2 control-label">Capcacity</label>
                  <div class="col-sm-12">
                    <input type="number" class="form-control" value="<?= $data['capcacity']; ?>" id="capcacity" name="capcacity" placeholder="Capcacity" required>
                  </div>
                </div> 
    ...
    <label for="box_length" class="col-sm-2 control-label">Box Length</label>
                  <div class="col-sm-12">
                    <input type="number" class="form-control" value="<?= $data['box_length']; ?>" id="box_length" name="box_length" placeholder="Box Length" required>
                  </div>
                </div> 
    ...
    <label for="box_width" class="col-sm-2 control-label">Box Width</label>
                  <div class="col-sm-12">
                    <input type="number" class="form-control" value="<?= $data['box_width']; ?>" id="box_width" name="box_width" placeholder="Box Width" required>
                  </div>
                </div> 
