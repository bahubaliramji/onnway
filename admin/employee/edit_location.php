                        ...
                        <form role="form" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['lat']; ?>" name="lat" placeholder="Enter Latitude"
                                        required>
                                </div>

                                <div class="form-group">
                                    <label for="lng">Longitude</label>
                                    <input type="text" class="form-control" value="<?= $data['lng']; ?>" name="lng" placeholder="Enter Longitude"
                                        required>
                                </div>
