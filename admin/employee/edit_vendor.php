				  ...
				  while($row = mysqli_fetch_array($run_query))
				  {
					...
					?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['password']; ?>" name="password" placeholder="Enter Password"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone</label>
                                    <input type="number" class="form-control" value="<?= $data['phone']; ?>" name="phone" placeholder="Enter Phone"
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="<?= $data['account_number']; ?>" name="account_number"
                                        placeholder="Enter Account Number" required>
                                </div>
                                <div class="form-group">
                                    <label for="account_name">Account Name</label>
                                    <input type="text" class="form-control" value="<?= $data['account_name']; ?>" name="account_name"
                                        placeholder="Enter Account Name" required>
                                </div>
                                <div class="form-group">
                                    <label for="IFSC">IFSC</label>
                                    <input type="text" class="form-control" value="<?= $data['IFSC']; ?>" name="IFSC" placeholder="Enter IFSC"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="Bank">Bank</label>
                                    <input type="text" class="form-control" value="<?= $data['Bank']; ?>" name="Bank" placeholder="Enter Bank"
                                        required>
                                </div>
                                <div class="form-group">
