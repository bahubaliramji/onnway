        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="dashboard2.php">Home</a></li>
              <li class="breadcrumb-item active"><a href="worker_jobs2.php">Workers Jobs</a></li>
        ...
        <div class="row">
              ...
              <div class="card-body">
				...
				<dt>Salary package</dt>
                  ...
                  <tr>
                    ...
                    <td><?= $sno; ?></td>
                    <td><a href="worker_profile2.php?id=<?= $workerdata['user_id']; ?>"><?= $workerdata['name']; ?></a></td>
		  ...
		  <div class="col-md-3">
            ...
            if(isset($_POST['deactivate']))
            {
				...
				$question_insert = "UPDATE `jobs` SET `status` = 'Inactive' WHERE `id` = '$id'";
            ...
            if(isset($_POST['activate']))
            {
				...
				$question_insert = "UPDATE `jobs` SET `status` = 'Active' WHERE `id` = '$id'";
                if(mysqli_query($con,$question_insert))
                {
                  header('Location:worker_jobs2.php');
                }
