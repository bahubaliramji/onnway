 ...
 include("TBXadmin/include/config.php"); 
   ...
   if($_SESSION['vehicle_id']==""){
	...
	if(isset($_POST['post_truck'])){
		...
		$resultB = mysqli_query($dbhandle, "SELECT id FROM tbl_post_truck order by id desc limit 1");
		...
		$insert = mysqli_query($dbhandle, "Insert INTO tbl_post_truck(vehicle_owner_id, truck_id, post_truck_id, source, destination, truck_type, weight,  schedule_date, created_date)VALUE('".$_SESSION['vehicle_id']."','".$truck_id."','$post_truck_id' ,'".$source."','".$destination."','".$truck_type."','".$weight."','".$schedule_date."','".date('h:i:s d-m-Y')."')");
		$update = mysqli_query($dbhandle, "UPDATE `tbl_trucks` SET `post_status` = '2' WHERE `id` = '".$truck_id."'");
		...
		<div class="col-md-7">	
			<div class="box-style-of-view-order">
				...
				<div id="London" class="tabcontent" style="display: block;">
					...
					<div class="personal-information-form choose-type mobile-form1 c">
					<div class="row">
                        <div class="col-md-12">
                 
						<div class="col-md-6">
							<label>  Source  <span style="color:red">*</span></label>
							<select name="source" id="source" class="form-control slct-source">
						...
						<div class="col-md-6">
							...
							<select name="destination[]" id="destination" class="form-control select2 mobile3 select21" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
					...
					<div class="row">
						<div class="col-md-12 truck-regis">
                         <div class="col-md-12">
                           

							<label>Truck Reg. No.  <span style="color:red">*</span></label>
							<select name="truck_id" id="truck_id" class="form-control truck-form">
								<option value="">Select Truck Reg No</option>
								<?php 
									$result = mysqli_query($dbhandle, "SELECT id,truck_reg_no FROM tbl_trucks WHERE vehicle_owner_id = '".$_SESSION['vehicle_id']."'  order by id desc");
					...
					<div class="row">
						...
						<div class="col-md-6 for-seting">
                            
							<label class="mar-lf"> Weight in Ton   <span style="color:red">*</span></label>
							<input id="weight" class="form-control weight" Placeholder="Weight in Ton" type="text" name="weight" value="">
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6 for-seting">
							<label class="mar-lf"> Select Scheduled Date  <span style="color:red">*</span> </label>
					...
					<div class="row">
						...
						<div class="col-md-8 mobile-zero-padding">
							<button type="submit" name="post_truck"  class="update-password-btn two33 three">Post Truck</button>
						</div>
						</div>
						</div>
					</div> 
