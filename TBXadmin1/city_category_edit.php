...
$update = mysqli_query($dbhandle, "UPDATE tbl_city_category SET category_name = '$category_name' WHERE id = '$editid'"); 


}
	
	$select = mysqli_query($dbhandle, "select * from tbl_city_category where id='".$editid."'");
					...
					<div class="row">
                        ...
                        <ol class="breadcrumb">
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
                            <li><a href="city_category.php">Category</a></li>
							<li class="active" style="color:#f0193f">Category Edit</li>
						 </ol>
										...
										<div id="general_info">
											...
											<br><br>
											  ...
											  <div class="row">
									     <div class="col-sm-5">
										    <label style="font-size: 157%;"><u>Category Edit :</u></label>
										 </div>
