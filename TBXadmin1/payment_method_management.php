					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header with-border">
								...
								<h3 class="box-title">Payment Method Management</h3>
										...
										?>
											<tr>
												...
												<td>
													...
													<a style="margin-left: 10px;" href="payment_method_management.php?del_id=<?php echo $fetch['payment_method_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete?')">Delete</a>
												</td>
											</tr>
										<?php $x++;
										} ?>
