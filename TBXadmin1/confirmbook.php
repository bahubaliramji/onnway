...
if($_SESSION['user_id']==''){
 ...
 <html>
<head>
  <title>Technobrix | Confirm Booking Edit</title>
						...
						<div class="col-xs-12">
							...
							<div class="box">
								<div class="box-header with-border">
										...
										<i class="fa fa-eye" aria-hidden="true"></i><h3 class="box-title">Confirm Booking</h3>
...
<div class="box-body box box-warning">		
                        ...
                        <ol class="breadcrumb">
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							...
							<li class="active" style="color:#f0193f">Confirm Booking</li>
						 </ol>
                      </div>
										...
										<table id="example1" class="table table-bordered table-striped">
											...
											<tr>
													...
													<td>
                                                    <a href="confirm_edit.php"><span class="btn btn-success btn-xs"><i class="fa fa-edit"></i>Edit</span></a>
