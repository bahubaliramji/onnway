...
while ($fetch = mysqli_fetch_array($row))
{
	...
	<td>							<a href="order_track_edit.php?id=<?php
	echo $fetch['id']; ?>"><span class="btn btn-success btn-xs" id="edit21"><i class="fa fa-edit"></i>Track</span></a>																						</td>										</tr>										<?php
	$x++;
