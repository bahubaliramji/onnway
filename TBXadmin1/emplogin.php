...
<body class="skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<?php if (isset($_GET['del_id'])) {
			...
			$sql = mysqli_query($dbhandle, "DELETE FROM tbl_emp_login WHERE emp_id = '$deleteid'");
		...
		if ($_GET['tag']) {
			...
			$query = mysqli_query($dbhandle, "UPDATE tbl_emp_login SET status = '$prostatus' WHERE emp_id = '$sid'");
							...
							<div class="box-body box box-warning">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										$row = mysqli_query($dbhandle, "select * from tbl_emp_login");
										...
										?>
											...
											<tr>
												...
												<td style="width: 141px; padding: 7px;">
													...
													<a style="margin-left: 10px;" href="emplogin.php?del_id=<?php echo $fetch['emp_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete?')">Delete</a>
												</td>
