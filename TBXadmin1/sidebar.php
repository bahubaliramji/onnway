    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="<?php if($sidepage == 'login'){ echo 'active'; } ?> treeview">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($innersidepage == 'loadercompany'){ echo 'active'; } ?>"><a href="company-loader.php"><i class="fa fa-circle-o"></i>Company </a></li>
            <li class="<?php if($innersidepage == 'loaderindividual'){ echo 'active'; } ?>"><a href="individual-loader.php"><i class="fa fa-circle-o"></i> Individual</a></li>
          </ul>
        </li>
		...
		<li class="<?php if($sidepage == 'vehicle'){ echo 'active'; } ?> treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if($innersidepage == 'vehicleagent'){ echo 'active'; } ?>"><a href="vehicle-agent.php"><i class="fa fa-circle-o"></i> Transporter / Agent</a></li>
          </ul>
        </li>
		...
		<li class="<?php if($sidepage == 'bookmanag'){ echo 'active'; } ?> treeview">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($innersidepage == 'pendbook'){ echo 'active'; } ?>"><a href="emplogin.php"><i class="fa fa-circle-o"></i>Pending Booking</a></li>
            <li class="<?php if($innersidepage == 'confirmbook'){ echo 'active'; } ?>"><a href="calllogin.php"><i class="fa fa-circle-o"></i>Confirm Booking</a></li>
          </ul>
        </li>
	<?php } ?>
	...
	<?php if($type=='admin' OR $type=='call'){ ?>
		<li class="<?php if($sidepage == 'Booking'){ echo 'active'; } ?> treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if($innersidepage == 'booktruck'){ echo 'active'; } ?>"><a href="booktruk.php"><i class="fa fa-circle-o"></i> Post a Truck</a></li>
          </ul>
        </li>
