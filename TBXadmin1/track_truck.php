                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title"> Vehicle Truck Info </h3>
                            ...
                            <div class="box-body box box-warning">
                                ...
                                <div id="general_info">
                                    <form method="post" action="#" enctype="multipart/form-data">
                                        ...
                                        <div class="row col-md-12" id="track_loca"></div>
                                        <div class="row col-md-12" id="track_loc">
                                            ...
                                            <div class="map-section">
                                                <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDDOhWEH6qIYmon2vqRrbsOmSdS4w-LoAQ&callback=initMap">
                                                </script>
