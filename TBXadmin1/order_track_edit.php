...
if(isset($_POST['submit'])){ 
	...
	$update = mysqli_query($dbhandle, "update tbl_book_load SET status1='$status1',status2='$status2',status3='$status3',status4='$status4',status5='$status5',status1_time='$status1_time',status2_time='$status2_time',status3_time='$status3_time',status4_time='$status4_time',status5_time='$status5_time' where id='".$editid."'");
	if($update){
...
<?php
   ...
   $path = $base_url."../upload/vehicle_documents/";
	...
	$data = mysqli_fetch_array($select);	
		...
		?>
		<link rel="stylesheet" type="text/css" href="dist/css/bootstrap-datetimepicker.css">
										...
										<div class="col-sm-4">
										   <select name="status1" class="form-control" >
											...
											<?php 
												...
												while($fetch = mysqli_fetch_array($row)) {?>		 <option <?php echo (isset($_REQUEST['id']) && $fetch['id'] == $data['status1'] ? "selected" : "");?> value="<?php echo $fetch['id'];?>">	<?php echo $fetch['city_name'];?></option>	
												<?php }?>								
											</select>
										 </div>	
										<div class="col-sm-4">
										   <input type="text"  id="datetimepicker4" name="date" class="form-control" id="" value="<?php echo $data['status1_time'];?>" >
										 </div>											 
									  </div>
									  <div class="row">
									     <div class="col-sm-3">
									  ...
									  <div class="row">
										...
										<div class="col-sm-4">
										   <select name="status5" class="form-control" >
											...
											<?php 
												$row = mysqli_query($dbhandle, "select * from tbl_city order by city_name");
												while($fetch = mysqli_fetch_array($row)) {?>		 <option <?php echo (isset($_REQUEST['id']) && $fetch['id'] == $data['status5'] ? "selected" : "");?> value="<?php echo $fetch['id'];?>">	<?php echo $fetch['city_name'];?></option>	
												<?php }?>								
											</select>
										 </div>	
										<div class="col-sm-4">
