...
<?php if(isset($_GET['del_id'])){
 ...
 $sql = mysql_query("DELETE FROM tbl_trucks WHERE id = '$deleteid'");
...

{
	...
	$query = mysql_query("UPDATE tbl_trucks SET status = '$prostatus' WHERE id = '$sid'");
...
while($fetch = mysql_fetch_array($row)){
	...
	?>
											...
											<tr>
                                                    ...
                                                    <a href="vehicle_truck_edit_reg.php?edit_id=<?php echo $fetch['id'];?>"><span class="btn btn-success btn-xs"><i class="fa fa-edit"></i>Edit</span></a>
