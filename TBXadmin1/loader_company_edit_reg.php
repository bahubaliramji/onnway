					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header with-border">
								...
								<h3 class="box-title">Company Loader Register</h3>
							...
							<div class="box-body box box-warning">
								...
								<div id="general_info">
									<form method="post" action="#" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-sm-3"> <label>Designation <span style="color:red">*</span> :</label> </div>
											<div class="col-sm-4">
										...
										<div class="row">
											<div class="col-sm-3"> <label>Landline No.(with STD code)* <span style="color:red">*</span> :</label> </div>
											<div class="col-sm-4"> <input type="text" name="landline_no" class="form-control" value="<?php echo $data['landline_no']; ?>"> </div>
										</div>
										...
										<div class="row">
											<div class="col-sm-3"> <label>Company Website :</label> </div>
											<div class="col-sm-4"> <input type="text" name="company_website" class="form-control" value="<?php echo $data['company_website']; ?>"> </div>
										</div>
