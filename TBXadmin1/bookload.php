								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										while ($fetch = mysqli_fetch_array($row)) {
											$email = mysqli_fetch_array(mysqli_query($dbhandle, "SELECT * FROM tbl_loader WHERE id = '" . $fetch['loader_id'] . "'"));
											$status = mysqli_fetch_array(mysqli_query($dbhandle, "Select * from tbl_status where value = '" . $fetch['status'] . "' "));
										?>
											<tr>
												<td><?php echo $x; ?></td>
