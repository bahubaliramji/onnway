...
if($_SESSION['user_id']==''){
 ...
 ?>
  <html>
<head>
  <title>Technobrix | confirm booEdit</title>
					...
					<div class="row">
						<div class="col-xs-12">           
								<div class="box">
									<div class="box-header with-border">
										<i class="fa fa-edit" aria-hidden="true"></i><h3 class="box-title">Confirm Booking Edit</h3>
                        ...
                        <ol class="breadcrumb">
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							...
							<li class="active" style="color:#f0193f">Confirm Booking Edit</li>
						 </ol>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="phone" class="form-control" value="Post a Truck">
										 </div>								  
									  </div>
