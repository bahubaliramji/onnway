...
$query = mysqli_query($dbhandle, "Insert INTO  tbl_estimate(from_id,to_id,truck_type,price)VALUE('".$from_id."','".$to_id."','".$truck_type."','".$price."')");

		  $sms="<p style='success-msg'>Estimate Added Successfully.</p>";
					...
					<div class="row">
						<div class="col-xs-12">           
								<div class="box">
									<div class="box-header with-border">
										<i class="fa fa-edit" aria-hidden="true"></i><h3 class="box-title">Add Fare</h3>
                        ...
                        <ol class="breadcrumb">
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							<li class="active" style="color:#f0193f">Add Fare</li>
						 </ol>
				   ...
				   ?>
										...
										<div id="general_info">
											...
											<br><br>
											  ...
											  <div class="row">
									     <div class="col-sm-5">
										    <label style="font-size: 157%;"><u>Add Fare :</u></label>
										 </div>
                        ...
                        <select name="from_id" required="">
                        	...
                        	while($row = mysqli_fetch_assoc($sell)){
                             echo '<option value="'.$row['id'].'">'.$row['length'].' MT '.$row['dimension'].'</option>';
                        	}
                        	?>
                        </select>
