...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$query = mysqli_query($dbhandle, "Insert INTO tbl_city_category(category_name)VALUE('".$category."')");
		/*if($query){
						...
						<div class="col-xs-12">           
								<div class="box">
									<div class="box-header with-border">
										<i class="fa fa-edit" aria-hidden="true"></i><h3 class="box-title">Add Category</h3>
