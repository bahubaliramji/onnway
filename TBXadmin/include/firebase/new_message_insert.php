  ...
  
   {
		...
		$full_name=$rows['full_name'];
                 $image=$rows['image'];
                   ...
                   $qrys = "INSERT INTO `chat_user`(`sender_id`, `reciver_id`,`reciver_name`,`reciver_image`) VALUES ('$sender_id','$reciver_id','$full_name','$image')";
		...
		$ww = date('Y-m-d'); 
         ...
         $ab = date("h:i")."\n";
	      ...
	      $sql = "INSERT INTO `message` (`sender_id`,`reciver_id`,`message`,`message_image`,`date`,`time`) VALUES ('$sender_id','$reciver_id','$msg','','$date1234','$ab')";
