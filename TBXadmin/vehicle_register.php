				...
				<section class="content">
					...
					<div class="row" style="margin-right: 0px;margin-left: 0px;">
						<div class="box-header with-border" style="margin-left: 10px;">
										<i class="fa fa-user" aria-hidden="true"></i><h3 class="box-title">Vehicle Register</h3>
                           ...
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							<li class="active" style="color:#f0193f">Vehicle Register</li>
						 </ol>
                      </div>

						<div class="col-lg-3 col-xs-12" style="margin-left: 84px;">
						...
						<!-- small box -->
							...
							<div class="small-box bg-aqua" style="width: 277px;height: 118px; border-radius:15px;">
								...
								<div class="inner">
									<h4><strong><a href="vehicle-owner.php" style="color:white">Vehicle Owner</a></strong></h4>
									</div>
						...
						<div class="col-lg-3 col-xs-12" style="margin-left: 23px;">
							...
							<div class="small-box bg-green" style="width: 277px;height: 118px; border-radius: 15px;">
								...
								<div class="inner">
											<h4><strong><a href="vehicle-agent.php" style="color:white">Transporter / Agent</a></strong></h4>
