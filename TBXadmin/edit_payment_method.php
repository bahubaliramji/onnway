...
<?php
   $editid = $_GET['edit_id'];
	if(isset($_POST['submit'])){
		...
		$update = mysqli_query($dbhandle, "UPDATE tbl_payment_method SET payment_method = '$payment_method' WHERE payment_method_id = '$editid'");
		/*$query = mysqli_query("Insert INTO tbl_payment_method(payment_method,status)VALUE('".$payment_method."','".$status."')");*/
		
	}
$select = mysqli_query($dbhandle, "select * from tbl_payment_method where payment_method_id='".$editid."'");
							...
							<li class="active" style="color:#f0193f">Add Payment Method</li>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   ...
										   value="<?php echo $data['payment_method'];?>">
										 </div>								  
									  </div>
