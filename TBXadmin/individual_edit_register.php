...
<?php
   $editid = $_GET['edit_id'];
	...
	if(isset($_POST['submit'])){
		...
		$update = mysqli_query($dbhandle, "UPDATE tbl_loader_individual SET f_name = '$fname', l_name = '$lname', mb_no = '$phone', email = '$email'
	, password = '$password', repassword = '$repassword', address = '$address', city = '$city', pincode = '$pincode'
	, a_contact_no = '$altercontactinfo', a_mb_no = '$altermobnumber', landline_no = '$landlinenumber', pan_no = '$pan_number'
	, truck_used = '$trucktype', aadhar_no = '$aadhar_number' WHERE tbl_l_individual_id = '$editid'");
		/*if($query){
...
$select = mysqli_query($dbhandle, "select * from tbl_loader_individual where tbl_l_individual_id='".$editid."'");
                           ...
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							...
							<li class="active" style="color:#f0193f">Individual Loader Register</li>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="phone" class="form-control" value="<?php echo $data['mb_no'];?>">
										 </div>								  
									  </div>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="password" name="repassword" class="form-control" value="<?php echo $data['repassword'];?>">
										 </div>								  
									  </div>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="altercontactinfo" class="form-control" value="<?php echo $data['a_contact_no'];?>">
										 </div>								  
									  </div>
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="altermobnumber" class="form-control" value="<?php echo $data['a_mb_no'];?>">
										 </div>								  
									  </div>
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="landlinenumber" class="form-control" value="<?php echo $data['landline_no'];?>">
										 </div>								  
									  </div>
									    ...
									    <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="pan_number" class="form-control" value="<?php echo $data['pan_no'];?>">
										 </div>								  
									  </div>
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="trucktype" class="form-control" value="<?php echo $data['truck_used'];?>">
										 </div>								  
									  </div>
									  ...
									  <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="text" name="aadhar_number" class="form-control" value="<?php echo $data['aadhar_no'];?>">
										 </div>								  
									  </div>
