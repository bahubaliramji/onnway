...
$status= "active";
	...
	$tmp_path = $_FILES['pan_file']['tmp_name'];
	 ...
	 $email_count = mysqli_num_rows(mysqli_query($dbhandle, "SELECT * FROM tbl_loader_company WHERE email = '$email'"));
	...
	move_uploaded_file($tmp_path,$path.$service_img);
		$query = mysqli_query($dbhandle, "Insert INTO tbl_loader_company(f_name,l_name,mb_no,email,prof_image,password,repassword,address,
			...
			<div class="content-wrapper">
				...
				<section class="content">
				   ...
				   ?>	
						 ...
						 <div class="col-sm-6">
										<button type="submit" class="btn btn-primary" id="pro1" name="submit" >Register</button>
											</div>
             			                    </div>
