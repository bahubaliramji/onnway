                           ...
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							...
							<li class="active" style="color:#f0193f">Pending Booking</li>
										...
										<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
											<?php
 $selectuser=mysqli_query($dbhandle, "SELECT source, post_type FROM tbl_book_load UNION ALL
                    SELECT source, post_type FROM tbl_book_truck  ");
 $x=1;
        while($userrow=mysqli_fetch_array($selectuser)) {?>
											

											<tr>
													
													<td><?php echo $x;?></td>
													<td><?php echo $userrow['source'];?></td>
													<td> Mukul Rawat</td>
													<td><?php echo $userrow['post_type'];?></td>
													<td>Pending</td>
