...
$emp_img =$_FILES['pimage']['name'];
	$tmp_path = $_FILES['pimage']['tmp_name'];
	  if($emp_img==""){
	$update = mysqli_query($dbhandle, "UPDATE tbl_emp_login SET f_name = '$fname', l_name = '$lname', user_name = '$u_name', mobile_no = '$mb_no', email = '$email'
	, password = '$password', r_password = '$repassword', company_name = '$company', address = '$address' WHERE emp_id = '$editid'"); }
else{
     move_uploaded_file($tmp_path,$path.$emp_img);
      
		$update = mysqli_query($dbhandle, "UPDATE tbl_emp_login SET f_name = '$fname', l_name = '$lname', user_name = '$u_name', mobile_no = '$mb_no', email = '$email'
	, password = '$password', r_password = '$repassword', company_name = '$company', address = '$address', profile_img = '$emp_img' WHERE emp_id = '$editid'"); }

}
	/*if(isset($_POST['update_insti'])){
		$f_name = $_POST['f_name'];
		$query = mysqli_query("update tbl_institute SET f_name='".$f_name."' where emp_id='".$editid."'");
		if($query){
			$message = $obj->msg('success','Data Updated Successfully');
...
*/
	$select = mysqli_query($dbhandle, "select * from tbl_emp_login where emp_id='".$editid."'");
					...
					<div class="row">
                        ...
                        <ol class="breadcrumb">
                           <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
							...
							<li class="active" style="color:#f0193f">Employee Profile Edit</li>
						 </ol>
										...
										<div id="general_info">
											...
											<br><br>
											  ...
											  <div class="row">
									     <div class="col-sm-5">
										    <label style="font-size: 157%;"><u>Employee Profile Edit :</u></label>
										 </div>
									  ...
									  <div class="row">
									   ...
									   <div class="row">
										 ...
										 <div class="col-sm-4">
										   <input type="password" name="repassword" class="form-control" value="<?php echo $data['r_password'];?>">
										 </div>								  
									  </div>
									  ...
									  <div class="row">
										 ...
										 <div class="col-sm-4">
										 <textarea name="company" class="form-control" ><?php echo $data['company_name'];?></textarea>
										 </div>								  
									  </div> 
