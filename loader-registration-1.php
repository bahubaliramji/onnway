 ...
 if(isset($_POST['submit'])){
   ...
   $check=mysqli_num_rows(mysqli_query($dbhandle, "SELECT * FROM tbl_loader WHERE email = '$email' or mb_no = '".$mobile."'"));
if ($check >0 )
{
    $sms = '<p class="error-msg">User Already Exists or Password not Matched</p>';
}
  else
{
if($_POST['otp'] != $_SESSION['otp']){
   $query = mysqli_query($dbhandle, "Insert INTO tbl_loader(name,loader_type,mb_no,email,password,created_date)VALUE('".$name."','".$optradio."','".$mobile."','".$email."'
    ,'".$password."','".$created_date."')");
	
	$_SESSION['last_id'] = mysqli_insert_id($dbhandle) ;
  ...
  <div class="container">
     <div class="col-md-12 mobile-zero-padding" >
        <div class="loader-reg-stepper-1-style"> 
          <img src="images/loader-registration-stepper-1.png" class="img-responsive">
  <center>        <ul class="registyration12">
  ...
  <div class="col-md-2">
     ...
     <div class="col-md-8" >
        <div class="personal-information-section"> 
           ...
           <h3> SELECT TYPE &nbsp; &nbsp;  |<br class="visible-xs"> <span class="radio-tab">
...
<label class="radio-inline">
     ...
     <h4> PERSONAL INFORMATION </h4>
      ...
      <div class="personal-information-form mobile-form"  id="form_loader_reg_Show" style="display:none;">
         <div class="row">
            <div class="col-md-12">
          ...
          <div class="row">
			...
			<div class="col-md-6" id="otpdiv" style="display:none">
             ...
             <div class="col-md-6">
                ...
                <input type="email" name="email" id="loader_email" class="form-control marg15" placeholder="Enter your Email id">
             </div>
          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <input type="password" name="password" id="loader_passwordd" class="form-control marg15" placeholder="Enter your  password">
             </div>

             <div class="col-md-6">
                <label> Confirm password  <span style="color:red;">*</span></label>
                <input type="password" id="confirm_password" name="re_password" class="form-control marg15" placeholder="Enter your Confirm password">
             </div>
             
         </div>
		 <div class="row">
            <div class="col-md-8">
                <input type="checkbox" name="accept" value="agree" id="loader_agreed">&nbsp; &nbsp;I Accept <span class="terms-and-cond-style"> <a href="terms-n-condition.php" class="to_success"> Terms and condition </a></span> <span class="terms-and-cond-style">And <a href="privacy_policy.php" class="to_success"> Privacy Policy</a></span> 
             </div>
