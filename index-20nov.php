	...
	<div class="container">
		...
		<button type="button" class="post-tab-style">POST A LOAD</button><br>
			<span class="select-tab">
				<select name="source" id="cf_source">
			...
			<span class="select-tab">
				<select name="destination" id="cf_destination">
			...
			<span class="select-tab">
				<select name="vehicletype" id="cf_vehicletype" >
			...
			<span class="select-tab">
				<select name="materialtype" id="cf_materialtype">
		...
		<?php }else{ ?>
				 <button type="submit" name="submitt" class="check-fare-tab-style">CHECK FARE</button> 
				 <?php  }  ?>
			</span>
		</div>
	</form><?php }?>
