...
$query = mysql_query("SELECT * FROM tbl_trucks WHERE vehicle_owner_id = '".$_SESSION['vehicle_id']."' and id='".$_GET['truck_id']."'");
    ...
    <div class="content-1" id="truck_field">
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p> <br> <br>  <?php if(!empty($rowU['truck_permit_file'])){?><a href="<?php echo $path.$rowU['truck_permit_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p>  <br> <br>  <?php if(!empty($rowU['truck_reg_file'])){?><a href="<?php echo $path.$rowU['truck_reg_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
                ...
                <label> Truck validity </label>
                    ...
                    <input type='text' class="form-control" readonly value="<?php echo $rowU['truck_validity'];?>" name="truck_validity" id="datepicker" placeholder=" Truck Validity Date" />
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p> <br> <br>  <?php if(!empty($rowU['insurance_file'])){?><a href="<?php echo $path.$rowU['insurance_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
	  ...
	  <div class="row">
		...
		<div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p>  <br> <br>  <?php if(!empty($rowU['dl_file'])){?><a href="<?php echo $path.$rowU['dl_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
         ...
         <div class="truck-permit">
           ...
           <p>  <br> <br>  <?php if(!empty($rowU['aadhar_file'])){?><a href="<?php echo $path.$rowU['aadhar_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
 ...
 <div class="row">
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p>  <br> <br>  <?php if(!empty($rowU['fitness_cert_file'])){?><a href="<?php echo $path.$rowU['fitness_cert_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p>  <br> <br>  <?php if(!empty($rowU['auth_driver_cert_file'])){?><a href="<?php echo $path.$rowU['auth_driver_cert_file'];?>">Download File</a><?php }else{ echo "No file Uploaded";}?></p>
