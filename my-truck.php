 ...
 if(isset($_POST['delete']) && $_POST['truck_del_id']!=""){
   ...
   $landline_number = $_POST["landline_number"];
    $alternate_contact_person = $_POST["alternate_contact_person"];
 	...
 	$page_title = "My Truck";
	$seo_keyword = "My Truck";
	$seo_content = "My Truck";
	...
	<?php  if(isset($sms)){		echo $sms ;	}?>
       ...
       <div class="col-md-8">
          ...
          <div class="my-listed-truck">
            <h5> My listed Trucks </h5>
            <h4> <a href="<?php echo base_url ; ?>add-truck.php">+ ADD TRUCK</a></h4>
          </div>
<?php
		$result = mysqli_query($dbhandle, "SELECT * FROM tbl_trucks WHERE vehicle_owner_id = '".$_SESSION['vehicle_id']."' order by id desc");
		$serial_no = 1;
 ?>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td> <?php echo $rowU['created_date']; ?> </td>
                  <td> <?php echo $rowU['truck_reg_no']; ?> </td>
                  <td> <?php echo $rowU['driver_name']; ?> </td>
				  
				  <td>
				  <?php echo getFullStatus($rowU['post_status']);?>
				  </td>
                </tr>
              </tbody>
            </table>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="citypopupLabel">Are You sure to Cancel This Truck?</h4>
