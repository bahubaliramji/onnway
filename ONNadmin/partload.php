...
<section id="main-content">
    <section class="wrapper"> 
        ...
        <tbody><?php
           $row = mysqli_query($dbhandle,"select * from part_quote_details ORDER BY quote_id DESC");
$x=1;
	...
	?>
											<tr>
													...
													<td>
                                                        ...
                                                        ?>
                                                        <a href="enter_part_quote_price.php?id=<?php echo $id; ?>" class="btn btn-primary"><button class="btn btn-primary">ADD</button></a></td>
												    <td>
                                                        <?php
                                                            $id=$fetch['quote_id'];
                                                            
                                                        ?>
                                                        <a href="enter_part_quote_price.php?id=<?php echo $id; ?>" class="btn btn-primary"><button class="btn btn-primary">EDIT</button></a></td>
