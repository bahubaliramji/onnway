...
var id=<?php echo $_GET['id']; ?>;
  ...
  window.location="orderpartloadbookingphp.php?material_type="+material_type+"&id="+id+"&weight="+weight+"&length="+length+"&height="+height+"&width="+width+"&div1="+i1+"&div2="+i2+"&div3="+i3+"&div4="+i4+"&div5="+i5+"&div6="+i6+"&div7="+i7+"&div8="+i8;
}
</script>
</section>
