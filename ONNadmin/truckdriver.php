...
<section id="main-content">
    ...
    <div class="container" style="background-color: #fff; padding: 5px 5px 5px 5px; color: #111;">
        ...
        <tbody><?php
           $row = mysqli_query($dbhandle,"SELECT * FROM `driver_profile_tbl`");
$x=1;
...
while($fetch = mysqli_fetch_array($row)){
	...
	?>
											<tr>
                                             ...
                                             <td><a href="verifydriver.php?mobile_no=<?php echo $fetch['mobile_no']; ?>"><button type="button" class="btn btn-primary">VIEW</button></a></td>
                                            <td><a href="deldriver.php?mobile_no=<?php echo $fetch['mobile_no']; ?>"><button type="button" class="btn btn-primary">DELETE</button></a></td>
