...
$mobile_no=$_GET['mobile_no'];
 $row = mysqli_query($dbhandle,"SELECT * FROM  `driver_profile_tbl` where mobile_no='$mobile_no'");
...
<section id="main-content">
    <section class="wrapper" style="padding-left:40px;"> 
    	...
    	<form method="POST" action="updatedriverprofile.php">
