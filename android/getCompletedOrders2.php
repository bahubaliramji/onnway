...
$user_id = $_POST['user_id'];
 ...
 $row2 = mysqli_query($dbhandle,"SELECT * FROM `assigned_orders` where (user_id='$user_id' OR driver_number='$ph') AND (truck_status = 'completed' || truck_status = 'cancelled') ORDER BY created DESC ");
