...
$jsonResponse = array("vehicleagent_regis"=>array());

$insert = mysql_query("Insert INTO tbl_agent(f_name,l_name,mb_no,email,pro_image,password,repassword,address,
      city,pincode,a_c_no,a_m_no,landline_no,pan_no,truck_type,aadhar_no,comp_name,comp_type,service_tax,pan_file,
      company_website,status)VALUE('".$fname."','".$lname."','".$mb_no."','".$email."','".$comp_img."'
	...
	array_push($jsonResponse['vehicleagent_regis'],$details);
