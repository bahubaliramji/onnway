...
if($_POST['mobile']!=""){
	...
	if(is_numeric($mobile) && (strlen($mobile)==10)){
		...
		$check=mysql_num_rows(mysql_query("SELECT vehicle_owner_id FROM tbl_vehicle_owner WHERE  mb_no = '".$mobile."'"));
	...
	if($check >0)
	{
		...
		mysql_query("INSERT INTO otp_vehicle (mobile, otp)VALUES('".$_SESSION['mobile']."','".$_SESSION['otp']."')");
