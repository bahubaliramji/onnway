            ...
            <form action="" method="post">
              <div class="col-md-12 zero-padding">
                ...
                <div class="col-md-12 login-sec-style">
                  ...
                  <div class="divOuter">
                    <div class="divInner">
                      <input class="passotppp" id="passotp" class="form-control" name="passotp" type="text" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onKeyPress="if(this.value.length==4) return false;" />
                    </div>
                  </div>
                  <style>
                    .passotp {
  ...
  <div class="modal fade company-page-modal" id="myModalProvider" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div id="container_demo">
          ...
          <div id="loginw" class="animate form">
            <form action="" method="post">
              <div class="col-md-12 zero-padding">
                <h1>Login <button type="button" class="close" data-dismiss="modal">&times;</button></h1>
                <div class="col-md-12 login-sec-style">
