      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p></p>
            ...
            <label for="file-7"><i class="camera-truck fa fa-camera" aria-hidden="true"></i>&nbsp; &nbsp; <span><span style="color:red">*</span>Upload Image</span></label>
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p></p>
            ...
            <label for="file-5"><i class="camera-truck fa fa-camera" aria-hidden="true"></i>&nbsp; &nbsp; <span><span style="color:red">*</span>Upload Image</span></label>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
                ...
                <label> Truck validity & Insurance<span style="color:red">*</span> </label>
                    ...
                    <input type='text' class="datepicker form-control" name="truck_validity" id="datepicker" placeholder=" Truck Validity Date" />
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p></p>
            ...
            <label for="file-9"><i class="camera-truck fa fa-camera" aria-hidden="true"></i>&nbsp; &nbsp; <span><span style="color:red">*</span>Upload Image</span></label>
		...
		<div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p></p>
            ...
            <label for="file-11"><i class="camera-truck fa fa-camera" aria-hidden="true"></i>&nbsp; &nbsp; <span><span style="color:red">*</span>Upload Image</span></label>
      ...
      <div class="col-md-4">
         ...
         <div class="truck-permit">
           ...
           <p></p>
            ...
            <label for="file-6"><i class="camera-truck fa fa-camera" aria-hidden="true"></i>&nbsp; &nbsp; <span><span style="color:red">*</span>Upload Image</span></label>
