      ...
      <div class="col-md-3 col-sm-3 col-xs-12 logo">
        ...
        <div class="row"> 
            <div class="col-md-8 col-sm-8 col-xs-12">
                 <a href="#"><span class="down-app"><img src="<?php echo base_url ; ?>images/mobile.png" > &nbsp;  <span class="dwn-app-txt">Download App</span></span></a>
               
                <span class="phone-contact"><img src="<?php echo base_url ; ?>images/phone.png" > <span class="mobile-no-span">&nbsp;</span>+91 9 11 11 9 22 33</span>
             </div>   
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 login-part-right">
                <span class="login-part">
                    ...
                    <span>|</span>
                    <span class="login-section"><a href="<?php if(basename($_SERVER['PHP_SELF'])=='post-a-truck.php'){?>vehicle-registration.php<?php }else{?>loader-registration-1.php<?php }?>">REGISTRATION  
                    </a></span>
                  </span>
          </div>
          <?php } else { ?>
